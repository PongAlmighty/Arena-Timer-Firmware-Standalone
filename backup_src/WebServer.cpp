...
const int CS = 24;   // D24 (User confirmed CS rewired to D24/Pin36)
const int SCK = 10;  // Shim SPI SCK (GP10)
const int MOSI = 11; // Shim SPI MOSI (GP11)
const int MISO = 12; // Shim SPI MISO (GP12)
